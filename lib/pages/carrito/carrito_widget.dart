...
class CarritoWidget extends StatefulWidget {
  const CarritoWidget({
    super.key,
    String? valorInicial,
  }) : this.valorInicial = valorInicial ?? '0';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              context.pushNamed(ProductosWidget.routeName);
            },
          ),
          title: InkWell(
                                                        ...
                                                        padding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0),
                                                        child: Text(
                                                          'Precio:${containerProductosRecord.precio.toString()}',
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodySmall
                                                              .override(
                                                                    ...
                                                                    await listViewSubProductosRecord
                                                                      ...
                                                                      ...createSubProductosRecordData(
                                                                        subtotal: functions.restarSubtotal(
                                                                            listViewSubProductosRecord.subtotal,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                            ...
                            children: [
                              ...
                              StreamBuilder<List<SubProductosRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Text(
                                    functions
                                        .iva(textSubProductosRecordList
                                            .map((e) => e.subtotal)
                                            .toList())
                                        .toString(),
                                    style: FlutterFlowTheme.of(context)
                            ...
                            children: [
                              ...
                              StreamBuilder<List<SubProductosRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Text(
                                    functions
                                        .totalConIVA(textSubProductosRecordList
                                            .map((e) => e.subtotal)
                                            .toList())
                                        .toString(),
                                    style: FlutterFlowTheme.of(context)
                        ...
                        FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed(MetodoPagoWidget.routeName);
                          },
