...
export 'crear_perfil_model.dart';

class CrearPerfilWidget extends StatefulWidget {
  const CrearPerfilWidget({super.key});

  static String routeName = 'crearPerfil';
  static String routePath = '/crearPerfil';

  @override
  State<CrearPerfilWidget> createState() => _CrearPerfilWidgetState();
}

class _CrearPerfilWidgetState extends State<CrearPerfilWidget> {
  late CrearPerfilModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearPerfilModel());
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          suffixIcon: InkWell(
                            onTap: () async {
                              safeSetState(() => _model.txtPassVisibility =
