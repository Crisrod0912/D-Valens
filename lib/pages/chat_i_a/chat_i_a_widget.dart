...
class _ChatIAWidgetState extends State<ChatIAWidget> {
  ...
  void initState() {
    ...
    _model.txtfMsjIATextController ??= TextEditingController();
    _model.txtfMsjIAFocusNode ??= FocusNode();
  }
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: TextFormField(
                          controller: _model.txtfMsjIATextController,
                          focusNode: _model.txtfMsjIAFocusNode,
                          obscureText: false,
                          ...
                          maxLines: null,
                          validator: _model.txtfMsjIATextControllerValidator
                              .asValidator(context),
                        ),
                      ),
                      FFButtonWidget(
                        onPressed: () async {
                          await geminiGenerateText(
                            context,
                            _model.txtfMsjIATextController.text,
                          ).then((generatedText) {
                            safeSetState(
                                () => _model.respuesta = generatedText);
                          });
