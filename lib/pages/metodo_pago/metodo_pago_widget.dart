...
class MetodoPagoWidget extends StatefulWidget {
  ...
  static String routeName = 'MetodoPago';
  static String routePath = '/metodoPago';
                  ...
                  Padding(
                    ...
                    child: StreamBuilder<List<SubProductosRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<SubProductosRecord> buttonSubProductosRecordList =
                            snapshot.data!;
                        ...
                        final buttonSubProductosRecord =
                            buttonSubProductosRecordList.isNotEmpty
                                ? buttonSubProductosRecordList.first
                                : null;
                          ...
                          onPressed: () async {
                            if (isiOS) {
                              await launchUrl(Uri.parse(
                                  "sms:${_model.dropDownValue!}&body=${Uri.encodeComponent('PASE  ${_model.textController1.text}${valueOrDefault<String>(
                                buttonSubProductosRecord?.subtotal?.toString(),
                                '0',
                              ...
                              await launchUrl(Uri(
                                ...
                                queryParameters: <String, String>{
                                  'body':
                                      'PASE  ${_model.textController1.text}${valueOrDefault<String>(
                                    buttonSubProductosRecord?.subtotal
                                        ?.toString(),
                                    '0',
                                  )}${_model.textController2.text}${_model.textController3.text}',
                                },
