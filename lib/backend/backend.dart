...
import 'schema/catering_record.dart';
...
export 'schema/catering_record.dart';
...
/// Functions to query CateringRecords (as a Stream and as a Future).
Future<int> queryCateringRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      CateringRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<CateringRecord>> queryCateringRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      CateringRecord.collection,
      CateringRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<CateringRecord>> queryCateringRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
